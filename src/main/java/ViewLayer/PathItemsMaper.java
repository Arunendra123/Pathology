...
public class PathItemsMaper {
   public static PathItems mapItemsFromTextBox(PathItems pi) {
		  ...
		  pi.setCollectionAmount(Integer.parseInt(Text.t5.getText()));
   ...
   public static PathItems mapItemsFromTable(PathItems pi) {
       ...
       if (getSelectedRowForDeletion >= 0) {
           ...
           pi.setCollectionAmount(Integer.parseInt(Table.model.getValueAt(getSelectedRowForDeletion, 6).toString()));
   ...
   public static boolean validateTextFields() {
	  ...
	  System.out.print(Text.t1.getText());
	   ...
	   if(Text.t2.getText().equals("")||Text.t3.getText().equals("")||Text.t4.getText().equals("")||Text.t5.getText().equals("")||Text.t6.getText().equals("")) {
   ...
   public static boolean validateTableFields() {
		  ...
		  if(str.length==3) {
		   ...
		   if(Table.model.getValueAt(getSelectedRowForDeletion, 3).toString().equals("") || Table.model.getValueAt(getSelectedRowForDeletion, 4).toString().equals("")||Table.model.getValueAt(getSelectedRowForDeletion, 5).toString().equals("")||Table.model.getValueAt(getSelectedRowForDeletion, 6).toString().equals("")||Table.model.getValueAt(getSelectedRowForDeletion, 7).toString().equals("")) {
			   JOptionPane.showMessageDialog(null, "Please input correct amount");
			   return false;
		   }else {
			   ...
			   if(!isNumber(Table.model.getValueAt(getSelectedRowForDeletion, 6).toString())) {
				   JOptionPane.showMessageDialog(null, "Please input correct collection-amount");
				   return false;
			   }
